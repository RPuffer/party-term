                ...
                case '"':
                    if (last === '[' || last === ',') {
                        ...
                        if (quoted) {
                            ...
                            // quoted string done
                            quoted = false;
                            this.jsonStrings.push(new argument_1.Argument(escapedArg, argsContent.substring(start, i + 1), vscode_languageserver_types_1.Range.create(document.positionAt(argsOffset + start), document.positionAt(argsOffset + i + 1))));
                            escapedArg = "";
                        }
                        else {
                            // should be a , or a ]
